#ifndef STARSHOOTERSTATE_H__
#define STARSHOOTERSTATE_H__
#include "GameState.h"
#include "Star.h"
#include "Cfg.h"
#include "GameObject.h"
class StarShooterState : public GameState
{
...
public:
	StarShooterState(sf::RenderWindow& tv_) : GameState{ GStateType::SandboxStarShooter, tv_ } 
	...
	~StarShooterState() override final {}
